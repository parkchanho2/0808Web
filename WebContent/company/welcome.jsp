...
<%--상단 공통 페이지를 외부 포함파일로 처리해서 중복코드를 안하게 하고 유지 보수를 좋게 한다. => jsp:include
액션 태그라고 한다.이 방법은 추천--%>
...
<h1>Welcome</h1>
    <figure class="ceo"><img src="../images/company/CEO.jpg" width="196" height="226" alt="CEO" /><%-- figure는 html5에서 추가된 태그로 그림삽입해서 표현할 때
...
<%-- 하단 페이지 외부 포함파일 처리 (중복코드를 안하게 하고 유지보수가 좋아지고,효율성이 좋다
=> include 디렉티브--%>
